...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_wriitenBy_fkey" FOREIGN KEY ("wriitenBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
